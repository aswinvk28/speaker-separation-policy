...
if __name__=='__main__':
    ...
    if args.set == "train":
        ...
        compute_stats=False
    wav_list = os.path.join(data_dir,"zlists/wav_{0}.list".format(args.set))
    feat_list = os.path.join(data_dir,"zlists/feat_{0}.rscp".format(args.set))
    feat_dir = os.path.join(data_dir,"zfeat")
    ...
    for line in wav_files:
        ...
        wav_file = os.path.join(data_dir, wav_dir, line)
