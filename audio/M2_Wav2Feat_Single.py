...
fe = sp.FrontEnd(samp_rate=samp_rate,mean_norm_feat=True,frame_duration=0.032, frame_shift=0.02274)
...
htk.write_htk_user_feat(feat, feat_file, default_period=227400)
